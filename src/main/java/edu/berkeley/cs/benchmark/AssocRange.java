...
public class AssocRange extends Benchmark<List<Assoc>> {
  ...
  static void readAssocRangeQueries(String file, long[] nodes, int[] atypes, int[] offsets,
    int[] lengths) {
  ...
  @Override public void readQueries() {
    readAssocRangeQueries(WARMUP_FILE, warmupAssocRangeNodes, warmupAssocRangeAtypes,
      warmupAssocRangeOffsets, warmupAssocRangeLengths);
    readAssocRangeQueries(QUERY_FILE, assocRangeNodes, assocRangeAtypes, assocRangeOffsets,
      assocRangeLengths);
  }

  @Override public List<Assoc> warmupQuery(Graph g, int i) {
    return g
      .assocRange(warmupAssocRangeNodes[i], warmupAssocRangeAtypes[i], warmupAssocRangeOffsets[i],
