...
public class MixPrimitive extends Benchmark<Object> {
  ...
  @Override public void readQueries() {
    ...
    Node.getNodeQueries(Node.WARMUP_FILE, warmupNodeAttrIds1, warmupNodeAttrIds2, warmupNodeAttrs1,
      warmupNodeAttrs2);
    Node.getNodeQueries(Node.QUERY_FILE, nodeAttrIds1, nodeAttrIds2, nodeAttrs1, nodeAttrs2);

    NeighborNode.getNeighborNodeQueries(NeighborNode.WARMUP_FILE, warmupNeighborNodeIds,
      warmupNeighborNodeAttrIds, warmupNeighborNodeAttrs);
    NeighborNode
      .getNeighborNodeQueries(NeighborNode.QUERY_FILE, neighborNodeIds, neighborNodeAttrIds,
        neighborNodeAttrs);

    NeighborAtype
      .getLongInteger(NeighborAtype.WARMUP_FILE, warmupNeighborAtypeIds, warmupNeighborAtype);
  ...
  @Override public void benchLatency() {
    ...
    for (int i = 0; i < WARMUP_N; i++) {
      ...
      switch (randQuery) {
        case 0:
          ...
          break;
        case 1:
          graph.getNeighborNode(warmupNeighborNodeIds[i], warmupNeighborNodeAttrIds[i],
            warmupNeighborNodeAttrs[i]);
          break;
        case 2:
        ...
        case 3:
          ...
          break;
        case 4:
          graph.getNodes(warmupNodeAttrIds1[i], warmupNodeAttrs1[i], warmupNodeAttrIds2[i],
            warmupNodeAttrs2[i]);
          break;
      }
    }
    ...
    for (int i = 0; i < MEASURE_N; i++) {
      ...
      switch (randQuery) {
        ...
        case 1:
          start = System.nanoTime();
          List<Long> neighborNodes =
            graph.getNeighborNode(neighborNodeIds[i], neighborNodeAttrIds[i], neighborNodeAttrs[i]);
          end = System.nanoTime();
        ...
        case 4:
          start = System.nanoTime();
          Set<Long> nodeNodes =
            graph.getNodes(nodeAttrIds1[i], nodeAttrs1[i], nodeAttrIds2[i], nodeAttrs2[i]);
          end = System.nanoTime();
      ...
      @Override public void warmupQuery() {
        ...
        switch (randQuery) {
          ...
          case 1:
            ...
            g.getNeighborNode(warmupNeighborNodeIds[queryIdx], warmupNeighborNodeAttrIds[queryIdx],
          ...
          case 3:
            ...
            g.getNeighborAtype(warmupNeighborAtypeIds[queryIdx], warmupNeighborAtype[queryIdx]);
            break;
          case 4:
            queryIdx = rand.nextInt(node_warmup);
            g.getNodes(warmupNodeAttrIds1[queryIdx], warmupNodeAttrs1[queryIdx],
              warmupNodeAttrIds2[queryIdx], warmupNodeAttrs2[queryIdx]);
            break;
        }
      }
      ...
      @Override public int query() {
        ...
        switch (randQuery) {
          ...
          case 1:
            ...
            return g.getNeighborNode(neighborNodeIds[queryIdx], neighborNodeAttrIds[queryIdx],
          ...
          case 2:
            ...
            return g.getEdgeAttrs(edgeNodeId[queryIdx], edgeAtype[queryIdx]).size();
          case 3:
            // get_nhbrs(n, atype)
            queryIdx = rand.nextInt(neighborAtype_query);
            return g.getNeighborAtype(neighborAtypeIds[queryIdx], neighborAtype[queryIdx]).size();
          case 4:
            // get_nodes(attr1, attr2)
            queryIdx = rand.nextInt(node_query);
            return g.getNodes(nodeAttrIds1[queryIdx], nodeAttrs1[queryIdx], nodeAttrIds2[queryIdx],
