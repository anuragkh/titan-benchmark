...
public abstract class RunThroughput implements Runnable {
  ...
  @Override public void run() {
    ...
    System.out.println(
      "Client " + clientId + " warming up for " + (Benchmark.WARMUP_TIME / 1E9) + " seconds.");
    ...
    long results = 0;
    System.out.println(
      "Client " + clientId + " measuring for " + (Benchmark.MEASURE_TIME / 1E9) + " seconds.");
    ...
    System.out.println(
      "Client " + clientId + " cooling down for " + (Benchmark.COOLDOWN_TIME / 1E9) + " seconds.");
