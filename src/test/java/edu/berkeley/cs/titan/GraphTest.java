...
public class GraphTest {
  ...
  @BeforeClass public static void setUp() throws Exception {
    ...
    Configuration config =
      new PropertiesConfiguration(GraphTest.class.getResource("/benchmark.properties")) {{
    ...
    Configuration titanConfiguration =
      new PropertiesConfiguration(GraphTest.class.getResource("/titan-cassandra.properties"));
  ...
  @Before public void initalizeGraph() throws InterruptedException {
    g = new Graph();
  }
  ...
  @Test public void testGetNodes1() throws Exception {
  ...
  @Test public void testGetNeighborNode() throws Exception {
  ...
  @Test public void testGetNeighborAtype() throws Exception {
  ...
  @Test public void testObjGet() throws Exception {
  ...
  @Test public void testEdgeGet() throws Exception {
  ...
  @Test public void testAssocRange() throws Exception {
  ...
  @Test public void testAssocGet() throws Exception {
  ...
  @Test public void testAssocCount() throws Exception {
  ...
  @Test public void testAssocTimeRange() throws Exception {
    assertListEquals(Arrays.asList(4, 3, 2),
      assocToId(g.assocTimeRange(1, 1, 0, 1434934366842L, 100)));
    assertListEquals(Arrays.asList(4, 3), assocToId(g.assocTimeRange(1, 1, 0, 1434934366842L, 2)));
    assertListEquals(Arrays.asList(3, 2), assocToId(g.assocTimeRange(1, 1, 0, 1434704348505L, 2)));
